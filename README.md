...
| `NoMissile` | Anything but missiles | Same as base AI | PD Weapon | Base AI targets a missile | Prevents missile targeting. | `PD` | Weapons that should not snap to low-value missile targets. | Sometimes |
