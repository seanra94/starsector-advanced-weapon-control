...
|        PrioritisePD         | Everything                     | Missile > Fighter > small ship > big ship            | None          |             Always              |     Consistently prioritises smaller targets over larger targets (missiles count as being smaller than fighters). strict mode in Settings.editme     |            "Opportunist", "NoPD", "BigShips", "SmallShips", "Fighter"             | Any weapon that needs to reliably prioritise fighters and missiles over ships                                         | Yes                            |
...
|       ConservePDAmmo        | Varies                         | -                                                    | uses ammo, PD |        weapon ammo < 90%        |                                             When ammo < 90%, only fighters and missiles can be targeted                                              |                              "PD", "Fighter", "NoPD"                              | Maintain ammo reserves except in cases where PD targets are in range (e.g. Paladin)                                   | Usually not                    |
|         BurstPDSFT          | Anything                       | -                                                    | None          |                -                |                                                                When soft flux < N% or                                                                |                              "PD", "Fighter", "NoPD"                              | Maintain flux sustainability except in cases where PD targets are in range (e.g. Paladin)                             | Usually not                    |
|       HoldFT(Flx>N%)        | -                              | -                                                    | None          |               No                |                                                 Will stop firing when ship combined flux exceeds N%                                                  |                                         -                                         | high flux weapons                                                                                                     | Very                           |
|       HoldSFT(Flx>N%)       | -                              | -                                                    | None          |               No                |                                                   Will stop firing when ship soft flux exceeds N%                                                    |                                         -                                         | Trade burst damage potential for flux sustainability or maintain flux sustainability in target rich environments      | Sometimes                      |
...
|       ForceFT(Flx<N%)       | -                              | -                                                    | None          |                -                |             Circumvents firing restrictions (not targeting restrictions) of other tags such as AvoidShields when combined flux below N%              |                                         -                                         | Fire weapons more liberally while ship has flux to spare                                                              | No                             |
|      ForceSFT(Flx<N%)       | -                              | -                                                    | None          |                -                |               Circumvents firing restrictions (not targeting restrictions) of other tags such as AvoidShields when soft flux below N%                |                                         -                                         | Maximise weapon output, ration flux with additional targeting restrictions and/or HoldSFT(Flx>N%) (e.g. Gauss cannon) | Sometimes                      |
...
|      SynchronizedFire       | N/A                            | -                                                    | None          |               N/A               |                           Synchronizes all weapons in a group to fire in volleys at the rate of the slowest firing weapon                            |                                         -                                         | Coordinate alpha strikes to overload shields or maximise missile saturation                                           | No                             |
