        ...
        fun createCampaignButtonGroup(
            ...
            tags.forEachIndexed { index, tag ->
                ...
                val rowFillColor = when {
                    pinned -> CampaignGuiStyle.SELECTED_WEAPON_SHIP_IDLE_COLOR
                    unavailable -> null
                    else -> null
                }
                ...
                val baseColor = when {
                    ...
                    else -> CampaignGuiStyle.UNSELECTED_WEAPON_SHIP_IDLE_COLOR
                }
                val darkColor = when {
                    pinned -> CampaignGuiStyle.SELECTED_WEAPON_SHIP_HOVER_COLOR
                    unavailable -> CampaignGuiStyle.DISABLED_TAG_DARK_COLOR
                    else -> CampaignGuiStyle.UNSELECTED_WEAPON_SHIP_HOVER_COLOR
                }
