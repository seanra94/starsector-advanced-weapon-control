...
object CampaignGuiStyle {
    ...
    val DISABLED_TAG_BACKGROUND_COLOR: Color = Color(255, 255, 255, 245)
    val DISABLED_TAG_DARK_COLOR: Color = Color(225, 225, 225, 245)
    val DISABLED_TAG_BRIGHT_COLOR: Color = Color(255, 255, 255, 255)
    val DISABLED_TAG_TEXT_COLOR: Color = Color(220, 220, 220)
