...
class PDAtHardFluxTag(weapon: WeaponAPI, private val threshold: Float) : WeaponAITagBase(weapon) {
    private val freeFireCondition = FluxCondition(FluxMetric.HARD, FluxComparator.LESS_OR_EQUAL, threshold)
