...
object Settings : SettingsDefinition() {
    ...
    val customAITriggerHappiness = addSetting<Float>("customAITriggerHappiness", 1.1f)
    val customAIPerfectTargetLeading = addSetting<Boolean>("customAIAlwaysUsesBestTargetLeading", false)
    val customAIFriendlyFireCaution = addSetting<Float>("customAIFriendlyFireCaution", 1.1f)
    ...
    val strictBigSmall = addSetting<Boolean>("strictBigSmallShipMode", false, tryLunar = true)
